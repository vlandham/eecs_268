...
Static variables are ones that are shared by multiple instances of the class.  With normal class variables, each instance (object) of the class got its own set of variables.  There is one static variable that is accessed and modified by all instances of the class.

"Tutorial on using static variables":http://www.cprogramming.com/tutorial/statickeyword.html
