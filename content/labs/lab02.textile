...
Each class you create will consist of two files: a *header* file (_.h_) and *implementation* file (_.cpp_). 
...
Don't forget to place a semicolon (@;@) after the closing bracket of the class definition! 
...
@#include@ "_HeaderFileName.h_"

@using statements@

_returnType_ _ClassName_::_function_

@{@
	
p((. _method implementation_
...
p((. @NewException(const string & message ="")@

p(((. @: out_of_range(message.c_str())@

p((. @{} //Don't Forget these brackets!@
...
p((. @Matrix Matrix::inverse( ) const throw(NewException);@

Inside this function, the exception would be thrown like this:

p((. @throw NewException("error: message");@
...
_Example catching of an exception:_
