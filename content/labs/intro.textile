...
p((. @g++ -c HelloWorld.cpp		>> 		HelloWorld.o@
		
Link object files together:

p((. @g++ HelloWorld.o MyClass.o -o executable		>> 		executable@
...
p((. @g++ HelloWorld.o MyClass.o -o lab1@

@HelloWorld.o:HelloWorld.cpp MyClass.h@
p((. @g++ -c HelloWorld.cpp@
...
"sample makefile":http://people.eecs.ku.edu/~jvalland/268/files/intro/makefile
...
"Sample Program to Debug":http://people.eecs.ku.edu/~jvalland/268/files/lab01/sample_lab_with_debugging.tar
...
p((. @tar cf jvalland_project1.tar jvalland_project1@
...
*Note:* The submitted tar file for labs and projects should contain your _student id number_ as well as an indication as to which project / lab is being submitted.
